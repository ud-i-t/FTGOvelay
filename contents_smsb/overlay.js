...
const player1Elements = {
    ...
    teamName: document.getElementById("teamName1"),
...
const player2Elements = {
    ...
    teamName: document.getElementById("teamName2"),
...
function switchPlayer(elements, index) {
    ...
    elements.teamName.innerHTML = players[index].team;
    const oldindex = elements.index;
    ...
    if (oldindex >= 0) {
        elements.image.children[oldindex].style.display = "none";
        elements.teamImage.children[oldindex].style.display = "none";
    }
...
function updateText() {
    ...
    readScore().then(() => {
        ...
        score1.setAttribute("src", "score" + Math.min(obj["score1"], matchCount) + "_" + matchCount + ".png");
        score2.setAttribute("src", "score" + Math.min(obj["score2"], matchCount) + "_" + matchCount + ".png");
